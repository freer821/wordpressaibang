...
<div class="banner <?php echo (has_header_image())?'':'no-header-img';?>">
    ...
    <h1> <?php if ( is_day() ) :
            esc_html_e('Daily Archives','consulting-company'); echo ": ". get_the_date();
            elseif ( is_month() ) :
                esc_html_e('Monthly Archives','consulting-company'); echo ": ". get_the_date('F Y');
            elseif ( is_year() ) :
                esc_html_e('Yearly Archives','consulting-company'); echo ": ". get_the_date('Y');
            else :
                esc_html_e( 'Archives', 'consulting-company' );
            endif;  ?> 
    </h1>
    </div>
</div>
