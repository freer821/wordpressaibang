...
if (!function_exists('consulting_vc_elements')) {
    function consulting_vc_elements()
    {
        ...
        vc_map(array(
            ...
            'params' => array(
                ...
                array(
                    ...
                    'heading' => esc_html__('Title', 'consulting'),
                    'param_name' => 'title',
                    'dependency' => array('element' => 'box_style', 'value' => array('style_1', 'style_2', 'style_4', 'style_5', 'style_6', 'style_7'))
                ),
                array(
                    'type' => 'textfield',
                ...
                array(
                    ...
                    'heading' => esc_html__('Text', 'consulting'),
                    'param_name' => 'content',
                    'dependency' => array('element' => 'box_style', 'value' => array('style_1', 'style_3', 'style_4', 'style_5', 'style_6', 'style_7'))
                ),
                array(
                    'type' => 'css_editor',
                    'heading' => esc_html__('Css', 'consulting'),
        ...
        if ($consulting_config['layout'] == 'layout_14' or $consulting_config['layout'] == 'layout_16' or $consulting_config['layout'] == 'layout_los_angeles' or $consulting_config['layout'] == 'layout_new_delhi') {
            vc_map(array(
